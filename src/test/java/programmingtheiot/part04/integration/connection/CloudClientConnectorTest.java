...
public class CloudClientConnectorTest {
	...
	/**
	 * Test method for
	 * {@link programmingtheiot.gda.connection.UbidotsMqttCloudClientConnector#connectClient()}.
	 */
	...
	/**
	 * Test method for
	 * {@link programmingtheiot.gda.connection.UbidotsMqttCloudClientConnector#publishMessage(programmingtheiot.common.ResourceNameEnum, java.lang.String, int)}.
	 */
	@Test
	...
	public void testLedActuator() {
		...
		// in Ubidots, there is an event which sends LED_ON when the value of sensorDara
		// > 50.
